...
const assignment3 =()=> ({
    ...
    date: "",
    title: "Input Output!",
    description: "A circuit that uses a photoresistor to switch between a constant LED and a fading one depending on the light",
    url: "/inputoutput",
    featured: false
})
const assignment4 =()=> ({
...
const assignment6 =()=> ({
    imageSrc: WebComCover,
    category: "Assignment 6",
    date: "",
    title: "Talking to the Web!",
    description: "A circuit that uses a joystick in conjunction with a webpage to change LED colors",
    url: "/webcom",
    featured: false
})
const finalProject =()=> ({
    imageSrc: LightBarCover,
    category: "Final Project",
    date: "",
    title: "LED Light Bar Switches",
    description: "A circuit that uses keyboard switches to control a LED Light Bar",
    url: "/lightbar",
    featured: true
})